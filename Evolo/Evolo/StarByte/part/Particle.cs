...
namespace StarByte.part
{
    ...
    {
        public Texture2D Texture { get; set; }       //The texture that will be drawn to represnt the particle
        ...
        public Rectangle boundingBox { get; set; }     //bounding box for the particles to live insid
