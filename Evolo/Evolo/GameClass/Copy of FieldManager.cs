...
namespace Evolo.GameClass
{
    class FieldManagerCopy
    {
        ...
        public void Update(float milliScecondsElapsedGameTime)
        {
            ...
            tetromeno1.Update(new Vector2(gridStartPos.X + (tetromeno1GridPos.X * (blockTexture.Width * GlobalVar.ScaleSize.X)), gridStartPos.Y + (tetromeno1GridPos.Y * (blockTexture.Height * GlobalVar.ScaleSize.Y))), gridStartPos, GlobalVar.ScaleSize);
